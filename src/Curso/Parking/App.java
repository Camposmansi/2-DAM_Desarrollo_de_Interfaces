...
package Curso.Parking;

import Curso.Parking.modelo.Parking;
import Curso.Parking.modelo.Vehiculo;
...
public class App {
	...
	public static void registrarEntradaVehiculo() {
		...
		case 2:
			...
			v = new Vehiculo(matricula, marca, longitud);
			break;
		case 3:
			...
			v = new Vehiculo(matricula, marca, numPlazas);
		}
